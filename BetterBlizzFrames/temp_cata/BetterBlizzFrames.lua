...
local defaultSettings = {
    ...
    partyCastBarTimerXPos = 0,
    partyCastBarTimerYPos = 0,
    ...
    petCastBarTimerXPos = 0,
    petCastBarTimerYPos = 0,
    ...
    targetCastBarTimerXPos = 0,
    targetCastBarTimerYPos = 0,
    ...
    focusCastBarTimerXPos = 0,
    focusCastBarTimerYPos = 0,
    ...
    playerCastBarTimerXPos = 0,
    playerCastBarTimerYPos = 0,
