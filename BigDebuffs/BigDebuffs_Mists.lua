...
addon.Spells = {
	...
	[15752] = { type = CROWD_CONTROL }, -- Linken's Boomerang Disarm
	[46392] = { type = DEBUFF_OFFENSIVE }, -- Focused Assault
	[46393] = { type = DEBUFF_OFFENSIVE }, -- Brutal Assault
	[67890] = { type = CROWD_CONTROL }, -- Frag Belt, Engi incap
	...
	[77606] = { type = CROWD_CONTROL }, -- Dark Simulacrum
	...
	[114039] = { type = IMMUNITY_SPELL }, -- Hand of Purity
    ...
    [127797] = { type = ROOT }, -- Ursol's Vortex
    ...
    -- [110693] = { type = ROOT }, -- Frost Nova (Mage)
	...
	[113656] = { type = CROWD_CONTROL }, -- Fists of Fury
	...
	[137562] = { type = IMMUNITY_SPELL }, -- Nimble Brew
	[122278] = { type = BUFF_DEFENSIVE }, -- Dampen Harm
	[122783] = { type = IMMUNITY_SPELL }, -- Diffuse Magic
